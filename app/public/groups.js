    ...
    fetch(`/groups/:allgroups`)
        ...
        .then(data => {
            ...
            document.getElementById("greyContainer" + arr[0]).addEventListener("click", (event) =>{
                ...
                document.querySelector(".otherTitlesg").innerHTML = `Would you like to join ${data1.groupname}?`
            })
            // document.getElementById("greyContainer" + arr[1]).addEventListener("click", (event) =>{
            //     popup.style.display = "block";
            //     popupoverlay.style.display = "block";
            //     document.querySelector(".otherTitlesg").innerHTML = `Would you like to join ${data2.groupname}?`
            // })
            // document.getElementById("greyContainer" + arr[2]).addEventListener("click", (event) =>{
            //     popup.style.display = "block";
            //     popupoverlay.style.display = "block";
            //     document.querySelector(".otherTitlesg").innerHTML = `Would you like to join ${data3.groupname}?`
            // })
