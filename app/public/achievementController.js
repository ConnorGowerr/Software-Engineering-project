...
class AchievementController {
    constructor() {
        ...
        this.achievements = [
            ...
            new Achievement("5K Run", "time", 30),
            ...
            new Achievement("10% Body Fat Drop", "weight", 7),  
            new Achievement("Extreme Calorie Burn", "caloriesBurned", 7000),  
            new Achievement("Consistent Tracker", "caloriesTracked", 100),  
            new Achievement("1-Hour Run", "time", 60),  
            new Achievement("Healthy Bulk", "weight", 8),  
            new Achievement("Burn Master", "caloriesBurned", 6000),  
            new Achievement("Month-long Tracking", "caloriesTracked", 30),  
    ...
    //to display the selected achievement bigger in middle of screen (can clone or not both look fine)
